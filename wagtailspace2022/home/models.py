...
class NewsPage(Page):
    ...
    content_panels = Page.content_panels + [
        ...
        MultiFieldPanel([
            FieldPanel('subtitle'),
            FieldPanel('summary'),
        ], heading="Optional extras", classname="collapsed"),
    ]
...
class GalleryItem(Orderable):
    page = ParentalKey(GalleryPage, on_delete=models.CASCADE, related_name='galleryitems')
    image = models.ForeignKey(
        'wagtailimages.Image', on_delete=models.CASCADE, related_name='+'
    )
